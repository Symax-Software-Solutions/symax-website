...
export const SITE_CONTENT = {
  ...
  symaxHome: {
    hero: {
      badge: 'Sports Technology Software',
      headlineLines: ['Software Built', 'for the Sport.'],
      subtitle: "Symax builds the timing, graphics, and registration software that powers professional cycling events — from local club races to UCI World Championships.",
      cta1: 'Our Products',
      cta2: 'Get in Touch',
      email: 'michael.voss@symaxsoftware.com',
      clients: ['UCI', 'Swisstiming', 'Velosolutions', 'Red Bull Pumptrack'],
    },
    products: {
      label: 'Products',
      heading: 'One Ecosystem. Every Event.',
      subheading: 'Three products that work together — or independently — to run professional-grade cycling events.',
      items: [
        {
          id: 'phoenix',
          icon: '\u26a1',
          name: 'Phoenix',
          description: 'Cloud timing platform. Hardware-agnostic, real-time results, broadcast-ready graphics. Trusted at UCI World Championships.',
          badge: 'UCI Trusted',
          link: '/phoenix',
          cta: 'Learn more',
          featured: true,
        },
        {
          ...
          icon: '\U0001f3c1',
          name: 'RaceHub',
          description: 'Event registration reimagined. Athlete profiles, seamless Phoenix integration, transparent pricing at €1 per registration.',
          badge: null,
          link: '/racing',
          cta: 'Learn more',
          featured: false,
        },
        {
          ...
          icon: '\U0001f916',
          name: 'Agentic Crew',
          description: 'Real-time AI agent observability. Monitor your AI crews, track costs, and intervene live. Built for engineering teams.',
          badge: 'New',
          link: 'https://agenticcrew.io',
          cta: 'Visit site',
          featured: false,
        },
      ],
    ...
    why: {
      label: 'Why Symax',
      heading: 'Professional Software. Real Events.',
      pillars: [
        { icon: '\U0001f3c6', title: 'UCI World Championships', text: 'Contracted by Swisstiming for the 2024 UCI MTB World Championships in Switzerland.' },
        { icon: '\U0001f50c', title: 'Hardware-Agnostic', text: 'Works with MYLAPS, Race Result, and other RFID systems. No vendor lock-in.' },
        { icon: '\u2601\ufe0f', title: 'Cloud-Native', text: 'No local installs, no USB keys. Your timing platform runs in the cloud.' },
        { icon: '\u26a1', title: 'Real-Time', text: 'Zero-delay results. Live leaderboards update the moment a rider finishes.' },
      ],
    },
    stats: [
      { value: '3+', label: 'Years in production' },
      { value: '6x', label: 'Pumptrack World Championships' },
      { value: '2,300+', label: 'Riders timed per event' },
      { value: '0', label: 'Setup fees' },
    ],
    cta: {
      heading: 'Ready to work together?',
      subtext: "Whether you're timing a local race or the world championships — get in touch and we'll have you set up before race day.",
      email: 'michael.voss@symaxsoftware.com',
      button: 'Get in Touch',
    },
  },
